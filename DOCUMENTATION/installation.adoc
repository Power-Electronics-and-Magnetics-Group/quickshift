...
....
git clone https://github.com/abhijeet-b/quickshift.git
....

If you have a Subversion client, you can also do:


....
svn checkout https://github.com/abhijeet-b/quickshift.git
....
